...
function Banner({ page, img }: BannerProps) {
  return (
    <section
      className={` lg:h-[26rem] h-[14rem] xl:pt-[6rem] pt-0  bg-cover bg-center flex justify-center items-start flex-col relative px-0`}
    >
      <img
      ...
      <div className="absolute px-[7%]">
        ...
        <div className="mt-4 flex items-center">
          ...
          <span className="font-syne sm:text-lg text-white"> {page} </span>
        </div>
      </div>
    </section>
  );
