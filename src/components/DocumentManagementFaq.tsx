...
function DocumentManagementFaq() {
  ...
  return (
    <div>
          ...
          title="What is DMS?"
          answer="Our document management services is an end to end solution that involves data capturing, digitial archiving , physical archiving, document shredding  to ensure safeguarding and easy retrieval of documents.
"
        />
        <FaqAccordion
          index={1}
