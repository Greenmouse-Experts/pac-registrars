...
const DmsModal: React.FC<ModalProps> = ({ open, handleClose }: ModalProps) => {
      ...
      >
        <Box sx={style}>
          <form className="flex w-full bg-white flex-col 2xl:gap-8 gap-5">
            ...
            <Input label="Name of organization" type="text" />
            <Input
              label="Brief details of the service you want from us"
              type="text"
            />
