...
"
          ...
          answer={
            <div>
              ...
              <ul>
                ...
                <BsDot color="black" size={30}/>  Filled change of address form
                </li>
                <li className="flex items-center gap-1">
                <BsDot color="black" size={30}/>  DMarriage certificate (original for sighting)
                </li>
                <li className="flex items-center gap-1">
                ...
                <li className="flex items-center gap-1">
                <BsDot color="black" size={30}/>  Banker's confirmation of signature.
                </li>
                <li className="flex items-center gap-1">
        ...
        <FaqAccordion
          ...
          answer={
            <div>
              <p>Kindly come to our office with the following documents for the transmission of shares.</p>
              <ul>
                <li className="flex items-center gap-1">
                ...
                <li className="flex items-center gap-1">
                <BsDot color="black" size={30}/>  Newspaper publication/Gazette
                </li>
                <li className="flex items-center gap-1">
                <BsDot color="black" size={30}/>  Valid means of identification
                </li>
                <li className="flex items-center gap-1">
                <BsDot color="black" size={30}/>  Physical sighting of the administrators.
                </li>
                <li className="flex items-center gap-1">
                <BsDot color="black" size={30}/>  Banker's confirmation of signature.
                </li>
