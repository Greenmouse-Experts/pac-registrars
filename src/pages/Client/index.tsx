      ...
      <section className="md:py-32 py-10 bg-[#f4f4f4] flex items-center justify-between ">
        <div className="font-syne w-full">
          ...
          <div className="grid md:grid-cols-4 grid-col-1 gap-4 w-full my-10">
            ...
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-36.png" alt="" className="max-h-24" />
            </div>
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
            ...
            {/* <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-38.png" alt="" className="max-h-24" />
            </div> */}
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-25.svg" alt="" className="max-h-24" />
            </div>
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-39.png" alt="" className="max-h-24" />
            </div>
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-37.jpg" alt="" className="max-h-24" />
            </div>
            ...
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-40.png" alt="" className="max-h-24" />
            </div>
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
            ...
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-31.png" alt="" className="max-h-24" />
            </div>
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-32.png" alt="" className="max-h-24" />
            </div>
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
            ...
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-13.svg" alt="" className="max-h-24" />
            </div>

            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-29.svg" alt="" className="max-h-24" />
            </div>
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-30.svg" alt="" className="max-h-24" />
            </div>
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-31.svg" alt="" className="max-h-24" />
            </div>
            ...
            <div className="bg-white px-10 h-[150px] flex items-center justify-center rounded-xl ">
              <img src="/images/client-29.jpg" alt="" className="max-h-40" />
            </div>
          </div>
        </div>
      </section>
